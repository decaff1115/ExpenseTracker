...
const EmployeeDetail = () => {
    ...
    const getRouteCodeById = (jeepId) => {
        const selectedJeep = jeep.find((j) => j.id === jeepId);
        return selectedJeep ? selectedJeep.route_code : '';
    };
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            {remittanceSlip.map((entry) => (
                                <tr key={entry.id}>
                                    <td>{entry.jeep_id}</td>
                                    <td>{getRouteCodeById(entry.jeep_id)}</td>
                                    <td>{entry.trip_no}</td>
